  ...
  return (
    <section className='relative w-full h-fit flex flex-col justify-between max-sm: pt-20'>
      <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
        ...
        <div className='absolute bottom-[-16%] max-[400px]:bottom-[-25%] flex flex-col justify-center items-center md:min-w-[768px] md:left-1/2 transform md:-translate-x-1/2 py-8 border border-zinc-300  shadow-lg shadow-indigo-500/40 rounded-2xl bg-zinc-200 max-sm: py-4  max-sm:w-[80%]  max-sm:left-[10%]'>
